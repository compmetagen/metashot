...
argp.add_argument( "--output", dest="output",
    metavar = "output.txt", help = "Output tab-delimited text table" )
...
def _main( ):
    ...
    merge(args.aistms, [os.path.split(os.path.basename(f))[1] for f in args.aistms], 0, output_handle)
    output_handle.close()
