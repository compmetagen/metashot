...
You need to download GeneMark-ES from http://exon.gatech.edu/GeneMark/license_download.cgi and deposit the license key in your home directory (.e. the /root diectory inside the docker) as .gm_key.
...
This will only work for EBI users and this section will be removed in the future.
